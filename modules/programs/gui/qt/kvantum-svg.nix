{
	...
	home-manager.users.${vars.user.name} = {vars, ...}: let
		...
		toRawHex = color: lib.removePrefix "#" color;

		themeName = vars.theme.name;
		themeDir = "Kvantum/${themeName}";
		getBase = num: key: default: c.base.${"0" + num} or default;
		base00 = toRawHex (getBase "0" "bg" c.base."00");
		base01 = toRawHex (getBase "1" "surface" c.base."01");
		base02 = toRawHex (getBase "2" "overlay" c.base."02");
		base03 = toRawHex (getBase "3" "muted" c.base."03");
		base04 = toRawHex (getBase "4" "border" c.base."04");
		base05 = toRawHex (getBase "5" "main" c.base."05");
		base06 = toRawHex (getBase "6" "light" c.base."06");
		base07 = toRawHex (getBase "7" "heading" c.base."07");
		base0D = toRawHex c.accent.fg.normal.${accentColor};
	in {
		xdg.configFile."${themeDir}/${themeName}.svg".text = ''
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="845" height="695" version="1">
			  ...
			  <g id="dial" transform="matrix(0.95744681,0,0,0.95744681,359.41894,236.51316)">
			    <rect id="dial-handle-4" style="opacity:0.00100002;fill:none;stroke:#000000;stroke-width:1.04444" width="10.444" height="10.444" x="104.86" y="228.25" rx="0" ry="0" />
			  </g>
			  ...
			  <g id="itemview-toggled-left" transform="matrix(0.44036689,0,0,-1.999996,510.85999,2181.7643)">
			    <rect style="fill:#${base04}" width="2" height="21" x="-721.81" y="789.58" />
			  </g>
			  <g id="itemview-toggled-bottom" transform="matrix(0.84070043,0,0,-1.1999995,799.02299,1538.1001)">
			    <rect style="fill:#${base04}" width="55" height="2" x="-719.81" y="777.58" />
			  </g>
			  <rect id="itemview-toggled-top" style="fill:#${base04}" width="46.239" height="3.6" x="193.88" y="-560.6" transform="scale(1,-1)" />
			  <g id="itemview-toggled-right" transform="matrix(0.44036689,0,0,-1.999996,532.87829,2181.7643)">
			    <rect style="fill:#${base04}" width="2" height="21" x="-664.81" y="789.58" />
			  </g>
			  <rect id="itemview-toggled" style="fill:#${base04}" width="46.239" height="42" x="193.88" y="-602.6" transform="scale(1,-1)" />
			  <path id="itemview-toggled-topleft" style="fill:#${base04}" d="m 193.88074,556.99973 c -0.48641,0 -0.88073,1.0745 -0.88073,2.4 v 1.2 h 0.88073 v -1.2 z" />
			  <path id="itemview-toggled-bottomright" style="fill:#${base04}" d="m 241,602.59961 a 0.88073379,2.3999989 0 0 1 -0.88074,2.4 v -2.4 z" />
			  <path id="itemview-toggled-bottomleft" style="fill:#${base04}" d="m 193,602.59961 a 0.88073379,2.3999989 0 0 0 0.88074,2.4 v -2.4 z" />
			  <path id="itemview-toggled-topright" style="fill:#${base04}" d="m 240.11927,556.99973 c 0.48641,0 0.88073,1.0745 0.88073,2.4 v 1.2 h -0.88073 v -1.2 z" />
			  ...
			  <rect id="itemview-pressed-top" style="fill:#${base04}" width="46.239" height="3.6" x="271.88" y="-560.6" transform="scale(1,-1)" />
			  <g id="itemview-pressed-right" transform="matrix(0.44036689,0,0,-1.999996,610.8783,2181.7643)">
			    <rect style="fill:#${base04}" width="2" height="21" x="-664.81" y="789.58" />
			  </g>
			  <rect id="itemview-pressed" style="fill:#${base04}" width="46.239" height="42" x="271.88" y="-602.6" transform="scale(1,-1)" />
			  <path id="itemview-pressed-topleft" style="fill:#${base04}" d="m 271.88074,556.99973 c -0.48641,0 -0.88073,1.0745 -0.88073,2.4 v 1.2 h 0.88073 v -1.2 z" />
			  <path id="itemview-pressed-bottomright" style="fill:#${base04}" d="m 319,602.59961 a 0.88073379,2.3999989 0 0 1 -0.88074,2.4 v -2.4 z" />
			  <path id="itemview-pressed-bottomleft" style="fill:#${base04}" d="m 271,602.59961 a 0.88073379,2.3999989 0 0 0 0.88074,2.4 v -2.4 z" />
			  <path id="itemview-pressed-topright" style="fill:#${base04}" d="m 318.11927,556.99973 c 0.48641,0 0.88073,1.0745 0.88073,2.4 v 1.2 h -0.88073 v -1.2 z" />
			  <g id="splitter-grip-focused" style="opacity:0" transform="translate(502.42498,-393.92675)">
			    <path style="fill:#${base04}" d="m 227.5,690 c 0,1.3807 -1.11929,2.5 -2.5,2.5 -1.38071,0 -2.5,-1.1193 -2.5,-2.5 0,-1.3807 1.11929,-2.5 2.5,-2.5 1.38071,0 2.5,1.1193 2.5,2.5 z" />
			    <g style="fill:#${base04}">
			      <path style="fill:#${base04}" d="m 226.9643,683.9643 c 0,1.0848 -0.87944,1.9643 -1.96429,1.9643 -1.08484,0 -1.96428,-0.8795 -1.96428,-1.9643 0,-1.0849 0.87944,-1.9643 1.96428,-1.9643 1.08485,0 1.96429,0.8794 1.96429,1.9643 z" />
			      <path style="fill:#${base04}" d="m 226.9643,696.0357 c 0,1.0848 -0.87944,1.9643 -1.96429,1.9643 -1.08484,0 -1.96428,-0.8795 -1.96428,-1.9643 0,-1.0849 0.87944,-1.9643 1.96428,-1.9643 1.08485,0 1.96429,0.8794 1.96429,1.9643 z" />
			    </g>
			  </g>
			  ...
			  <g id="slidercursor-pressed" transform="matrix(1.2,0,0,1.2,668.8,-15.800242)">
			    <rect style="opacity:0.00100002;fill-opacity:0.00392157" width="24" height="24" x="14" y="42" transform="matrix(0.83333333,0,0,0.83333333,-5.6666667,-6)" />
			    <circle style="fill:#${base04}" cx="14" cy="40" r="4" transform="matrix(2.0833333,0,0,2.0833333,-13.166666,-44.333332)" />
			    <circle style="fill:#${base04}" cx="14" cy="40" r="4" transform="matrix(1.875,0,0,1.875,-10.25,-36)" />
			  </g>
			  ...
			  <rect id="scrollbarslider-focused" style="fill:#${base03}" width="1" height="10" x="240" y="469" />
			  <g id="scrollbarslider-focused-right" transform="matrix(0.75,0,0,1,235.25,461.99976)">
			    <path style="fill:#${base03};fill-rule:evenodd" d="m 9,7 v 10 h 4 V 7 Z" />
			  ...
			  <g id="scrollbarslider-focused-topright" transform="matrix(0.75,0,0,0.75,235.25,462.74976)">
			    ...
			    <path style="fill:#${base03};fill-rule:evenodd" d="m 9,3 v 4 h 4 C 13,4.784 11.216,3 9,3 Z" />
			  </g>
			  <g id="scrollbarslider-focused-bottomright" style="fill:#${base03}" transform="matrix(0.75,0,0,0.75,235.25,467.24976)">
			    <path style="fill:#${base03};fill-rule:evenodd" d="m 9,21 v -4 h 4 c 0,2.216 -1.784,4 -4,4 z" />
			  ...
			  <g id="itemview-focused-left" transform="matrix(0.44036689,0,0,-1.999996,448.85999,2181.7643)">
			    <rect style="opacity:0.2;fill:#${base04}" width="2" height="21" x="-721.81" y="789.58" />
			  </g>
			  <g id="itemview-focused-bottom" transform="matrix(0.84070043,0,0,-1.1999995,737.02299,1538.1001)">
			    <rect style="opacity:0.2;fill:#${base04}" width="55" height="2" x="-719.81" y="777.58" />
			  </g>
			  <rect id="itemview-focused-top" style="opacity:0.2;fill:#${base04}" width="46.239" height="3.6" x="131.88" y="-560.6" transform="scale(1,-1)" />
			  <g id="itemview-focused-right" transform="matrix(0.44036689,0,0,-1.999996,470.87829,2181.7643)">
			    <rect style="opacity:0.2;fill:#${base04}" width="2" height="21" x="-664.81" y="789.58" />
			  </g>
			  <rect id="itemview-focused" style="opacity:0.2;fill:#${base04}" width="46.239" height="42" x="131.88" y="-602.6" transform="scale(1,-1)" />
			  <path id="itemview-focused-topleft" style="opacity:0.2;fill:#${base04}" d="m 131.88074,556.99973 c -0.48641,0 -0.88073,1.0745 -0.88073,2.4 v 1.2 h 0.88073 v -1.2 z" />
			  <path id="itemview-focused-bottomright" style="opacity:0.2;fill:#${base04}" d="m 179,602.59961 a 0.88073379,2.3999989 0 0 1 -0.88074,2.4 v -2.4 z" />
			  <path id="itemview-focused-bottomleft" style="opacity:0.2;fill:#${base04}" d="m 131,602.59961 a 0.88073379,2.3999989 0 0 0 0.88074,2.4 v -2.4 z" />
			  <path id="itemview-focused-topright" style="opacity:0.2;fill:#${base04}" d="m 178.11927,556.99973 c 0.48641,0 0.88073,1.0745 0.88073,2.4 v 1.2 h -0.88073 v -1.2 z" />
